...
## Setup
 ...
 - Make sure the download is fine using `sha256sum /tmp/ubuntu-18.04-server-amd64.iso`

 ```bash
a7f5c7b0cdd0e9560d78f1e47660e066353bb8a79eb78d1fc3f4ea62a07e6cbc  /tmp/ubuntu-18.04-server-amd64.iso
 ```
 - Make sure this SHA256 is [signed by ubuntu](https://help.ubuntu.com/community/VerifyIsoHowto){:.external}.
